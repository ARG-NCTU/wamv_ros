...
class Trajectory(object):
    def __init__(self):
        ...
        self.pub_cmd_drive = rospy.Publisher('/cmd_drive', roboteq_drive, queue_size = 1)
        self.count = 0
    ...
    def cb_right(self, empty):
        ...
        #self.stop()
        self.rostime_control(right=self.max_speed*0.5)
        self.stop()
    ...
    def cb_left(self, empty):
        ...
        #self.stop()
        self.rostime_control(left=self.max_speed*0.5)
        self.stop()
