...
class MyDriver:
  ...
  def CmdCallback(self, msg):
    if self.safe_flag == False:
      print ("autonomous")
      right_data = (msg.linear.x - msg.angular.z) * 990
      left_data = (msg.linear.x + msg.angular.z) * 990
      if left_data<990 and left_data>-990:
        self.ch2_pwm = left_data
      else:
        self.ch2_pwm = (left_data/abs(left_data))*990
      if right_data<990 and right_data>-990:
        self.ch1_pwm = right_data
      else:
        self.ch1_pwm = (right_data/abs(right_data))*990
