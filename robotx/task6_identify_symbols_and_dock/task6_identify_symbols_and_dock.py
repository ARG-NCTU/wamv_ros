...
class task6_node():
    def __init__(self):
        ...
        self.pub_dis = rospy.Publisher("~dis", Float32, queue_size=1)
    ...
    def process(self, event):
        ...
        tmp_x = dock_center_x - self.wamv_pose.position.x
        tmp_y = dock_center_y - self.wamv_pose.position.y
        dis.data = math.sqrt(tmp_x*tmp_x + tmp_y * tmp_y)
        self.pub_dis.publish(dis)
