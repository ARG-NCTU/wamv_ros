...
class Robot_PID():
    def __init__(self):
        ...
        self.cmd_ctrl_max = 1
        self.cmd_ctrl_min = -1
        self.station_keeping_dis = 3  # meters
        self.frame_id = 'odom'
        ...
        self.pub_cmd = rospy.Publisher(
            "cmd_drive", roboteq_drive, queue_size=1)
    ...
    def control(self, goal_distance, goal_angle):
        ...
        pos_output = self.pos_constrain(
            -self.pos_control.output / self.dis4constV)
